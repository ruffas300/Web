...
<!--            --><?php //} ?>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="<?php  if(strpos($_SERVER['PHP_SELF'],"/admin/")){echo 'reward_management.php';}else{echo'admin'.DS.'reward_management.php';} ?>">Rewards</a></li>
                <li><a href="<?php  if(strpos($_SERVER['PHP_SELF'],"/admin/")){echo 'service_management.php';}else{echo 'admin'.DS.'service_management.php';} ?>">Service Awards</a></li>
