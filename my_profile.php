...
//    }
    ...
    $filename_name = $user->first_name.$user->last_name.$user->employee_id.".".$ext;
    ...
    $path = $path . $filename_name;
    if($file['size'] > $max_filesizemove_uploaded_file($_FILES['uploaded_file']['tmp_name'], $path)) {
